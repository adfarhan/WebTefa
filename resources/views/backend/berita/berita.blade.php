        ...
        <section class="sejarah-id">
            <div class="container">
                <div class="button-back mb-3">
                    <a href="{{ route('berita.admin') }}"><i class="fa fa-arrow-left icon"></i>Kembali</a>
                </div>
                <!-- Card Header -->
                <div class="card shadow-lg border-0 rounded-3 p-4">
                    <div class="card-header text-dark d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Berita</h5>
                        <a href="{{ route('berita.create') }}" class="btn btn-outline-primary btn-sm"><i class="fa fa-plus"></i></a>
                    </div>
                </div>
                            ...
                            <table class="table align-middle table-borderless shadow-sm rounded overflow-hidden">
                                <thead style="background: linear-gradient(135deg, #89f7fe, #66a6ff); color: white;">
                                    <tr class="text-center">
                                        ...
                                        <th style="width: 30%; white-space: nowrap;">Isi Berita</th>
                                        <th style="width: 15%; white-space: nowrap;">Gambar</th>
                                        <th style="width: 15%; white-space: nowrap;">User</th>
                                ...
                                <tbody class="text-center">
                                    @foreach ($beritas as $berita)
                                        <tr class="align-middle" style="transition: background 0.3s;" onmouseover="this.style.background='#f2f7ff'" onmouseout="this.style.background='white'">
                                            ...
                                            <td class="text-start fw-semibold" style="font-size: 17px; white-space: nowrap;">{{ $berita->judul_berita }}</td>
                                            <td class="text-muted" style="font-size: 13px; white-space: nowrap;">{{ \Carbon\Carbon::parse($berita->tanggal_berita)->translatedFormat('d-m-Y') }}</td>
                                            ...
                                            <td>
                                                @if ($berita->gambar_berita)
                                                    <img src="{{ asset('storage/' . $berita->gambar_berita) }}" class="rounded-3 border shadow-sm" width="100">
                                                @else
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('berita.show', $berita) }}" class="btn btn-outline-success btn-sm" title="Lihat">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('berita.edit', $berita) }}" class="btn btn-outline-warning btn-sm" title="Edit">
