        ...
        <div class="card-container">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Landing <span>| Web Tefa</span></h5>
                    <p class="card-text">Meningkatkan keterampilan teknis dan kesiapan kerja bagi siswa.</p>
                    <div class="btn-container">
                        <a href="{{ route('landing.index') }}" class="btn btn-success btn-sm">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Keunggulan <span>| Web Tefa</span></h5>
                    <p class="card-text">Program TEFA memberikan pengalaman dunia kerja nyata bagi siswa.</p>
                    <div class="btn-container">
                        <a href="{{ route('keunggulan.index') }}" class="btn btn-success btn-sm">
                            Detail <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
