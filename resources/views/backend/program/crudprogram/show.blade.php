    ...
    <main id="main" class="main">
        <div class="container">
            ...
            <div class="card shadow-lg border-0 rounded-4 p-5 text-center">
                <h2 class="mb-4 fw-bold">{{ $program->nama_program }}</h2>
                <div class="mb-4">
                    <img src="{{ asset('storage/' . $program->gambar) }}" class="rounded-3 border shadow-sm" width="250">
                </div>
                <p class="fs-5 text-muted"><i>" {{ $program->deskripsi }} "</i></p>
            </div>
        </div>
    </main>
    <style>
