    ...
    <main id="main" class="main">
        <div class="container">
            <div class="button-back mb-3">
                <a href="{{ route('galeris.index') }}"><i class="fa fa-arrow-left icon"></i>Kembali</a>
            </div>
            <div class="card shadow-lg border-0 rounded-4 p-5">
                <form action="{{ route('galeris.update', $galeri) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_galeri" class="form-control shadow-sm" value="{{ $galeri->nama_galeri }}" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-semibold">Gambar</label>
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $galeri->foto) }}" class="rounded-3 border shadow-sm" width="120">
                        </div>
