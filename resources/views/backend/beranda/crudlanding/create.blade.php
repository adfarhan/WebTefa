            ...
            <div class="card shadow-lg border-0 rounded-4 p-5">
                <form action="{{ route('landing.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" class="form-control shadow-sm" placeholder="Masukkan nama " required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Penjelasan Singkat</label>
                        <textarea name="pekat" class="form-control shadow-sm" rows="3" placeholder="Masukkan profile " required></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Logo</label>
                        <input type="file" name="logo" class="form-control shadow-sm"  placeholder="Masukkan Logo " required>
                    </div>
